...
record InstructionInfo(int op, Instruction instruction, Params to, Params from,
    ...
    private final static InstructionInfo[] instArr = {
            ...
            new InstructionInfo(0x10, Instruction.STOP, Params.N, Params.NONE, 4), // 0 ?
            ...
            new InstructionInfo(0x20, Instruction.JR, Params.CC_NZ, Params.N, 12), // cycle 12 or 8
            ...
            new InstructionInfo(0x28, Instruction.JR, Params.CC_Z, Params.N, 8), // cycle 12 or 8
            ...
            new InstructionInfo(0x30, Instruction.JR, Params.CC_NC, Params.N, 8), // 12 or 8
            ...
            new InstructionInfo(0x38, Instruction.JR, Params.CC_C, Params.N, 8), // 12 or 8
            ...
            new InstructionInfo(0xC0, Instruction.RET, Params.CC_NZ, Params.NONE, 8), // 20 or 8
            new InstructionInfo(0xC1, Instruction.POP, Params.BC, Params.SP, 12),
            new InstructionInfo(0xC2, Instruction.JP, Params.CC_NZ, Params.NN, 12), // 16 or 12
            new InstructionInfo(0xC3, Instruction.JP, Params.PC, Params.NN, 16),
            new InstructionInfo(0xC4, Instruction.CALL, Params.CC_NZ, Params.NN, 12), // 24 or 12
            ...
            new InstructionInfo(0xC7, Instruction.RST, Params.PC, Params.NONE, 16),
            new InstructionInfo(0xC8, Instruction.RET, Params.CC_Z, Params.NONE, 8), // 20 or 8
            new InstructionInfo(0xC9, Instruction.RET, Params.NONE, Params.NONE, 16),
            new InstructionInfo(0xCA, Instruction.JP, Params.CC_Z, Params.NN, 12), // 16 or 12
            new InstructionInfo(0xCB, Instruction.ILL, Params.NONE, Params.NONE, 0),
            new InstructionInfo(0xCC, Instruction.CALL, Params.CC_Z, Params.NN, 12), // 24 or 12
            new InstructionInfo(0xCD, Instruction.CALL, Params.NONE, Params.NN, 24),
            new InstructionInfo(0xCE, Instruction.ADC, Params.A, Params.N, 8),
            new InstructionInfo(0xCF, Instruction.RST, Params.PC, Params.NONE, 16),
            new InstructionInfo(0xD0, Instruction.RET, Params.CC_NC, Params.NONE, 8), // 20 or 8
            new InstructionInfo(0xD1, Instruction.POP, Params.DE, Params.SP, 12),
            new InstructionInfo(0xD2, Instruction.JP, Params.CC_NC, Params.NN, 12), // 16 or 12
            new InstructionInfo(0xD3, Instruction.ILL, Params.NONE, Params.NONE, 0),
            new InstructionInfo(0xD4, Instruction.CALL, Params.CC_NC, Params.NN, 12), // 24 or 12
            ...
            new InstructionInfo(0xD7, Instruction.RST, Params.PC, Params.NONE, 16),
            new InstructionInfo(0xD8, Instruction.RET, Params.CC_C, Params.NONE, 8), // 20 or 8
            new InstructionInfo(0xD9, Instruction.RETI, Params.NONE, Params.NONE, 16),
            new InstructionInfo(0xDA, Instruction.JP, Params.CC_C, Params.NN, 12), // 16 or 12
            new InstructionInfo(0xDB, Instruction.ILL, Params.NONE, Params.NONE, 0),
            new InstructionInfo(0xDC, Instruction.CALL, Params.CC_C, Params.NN, 12), // 24 or 12
            ...
            new InstructionInfo(0xDF, Instruction.RST, Params.PC, Params.NONE, 16),
            ...
            new InstructionInfo(0xE7, Instruction.RST, Params.PC, Params.NONE, 16),
            ...
            new InstructionInfo(0xEF, Instruction.RST, Params.PC, Params.NONE, 16),
            ...
            new InstructionInfo(0xF7, Instruction.RST, Params.PC, Params.NONE, 16),
            ...
            new InstructionInfo(0xFF, Instruction.RST, Params.PC, Params.NONE, 16),
    };
